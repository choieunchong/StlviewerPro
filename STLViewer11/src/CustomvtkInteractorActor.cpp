...
void CustomvtkInteractorActor::OnMouseMove()
{
    int x = this->Interactor->GetEventPosition()[0];
    int y = this->Interactor->GetEventPosition()[1];
...
void CustomvtkInteractorActor::OnMiddleButtonDown()
{
    int x = this->Interactor->GetEventPosition()[0];
    int y = this->Interactor->GetEventPosition()[1];
...
//------------------------------------------------------------------------------
void CustomvtkInteractorActor::OnMiddleButtonUp()
{
    switch (this->State)
    {
    case VTKIS_DOLLY:
...
//------------------------------------------------------------------------------
void CustomvtkInteractorActor::OnRightButtonDown()
{
    int x = this->Interactor->GetEventPosition()[0];
    int y = this->Interactor->GetEventPosition()[1];
...
//------------------------------------------------------------------------------
void CustomvtkInteractorActor::OnRightButtonUp()
{
    switch (this->State)
    {
    case VTKIS_USCALE:
...
//------------------------------------------------------------------------------
void CustomvtkInteractorActor::Dolly()
{
    if (this->CurrentRenderer == nullptr || this->InteractionProp == nullptr)
    {
        return;
...
//------------------------------------------------------------------------------
void CustomvtkInteractorActor::UniformScale()
{
    if (this->CurrentRenderer == nullptr || this->InteractionProp == nullptr)
    {
        return;
...
//------------------------------------------------------------------------------
void CustomvtkInteractorActor::PrintSelf(ostream& os, vtkIndent indent)
{
    this->Superclass::PrintSelf(os, indent);
}

//------------------------------------------------------------------------------
void CustomvtkInteractorActor::FindPickedActor(int x, int y)
{
...
//------------------------------------------------------------------------------
void CustomvtkInteractorActor::Prop3DTransform(
